...
var builtinReporters = require('mocha/lib/reporters');
var growl = require('mocha/lib/nodejs/growl');
var utils = require('mocha/lib/utils');
var mocharc = require('mocha/lib/mocharc.json');
var Suite = require('mocha/lib/suite');
var esmUtils = utils.supportsEsModules(true)
  ? require('mocha/lib/esm-utils')
  : undefined;
...
Mocha.unloadFile = function(file) {
  ...
  return require('mocha/lib/nodejs/file-unloader').unloadFile(file);
};
...
Object.defineProperty(Mocha.prototype, 'version', {
  value: require('mocha/package.json').version,
  configurable: false,
  enumerable: true,
  writable: false
});
...
Mocha.prototype.parallelMode = function parallelMode(enable = true) {
  ...
  this._runnerClass = parallel
    ? require('mocha/lib/nodejs/parallel-buffered-runner')
    : exports.Runner;
